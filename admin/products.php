                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="short_desc" placeholder="Enter short desc"></textarea>
                            </div>
                        </div>
                ...
                <form id="edit-product-form" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label>Short Description</label>
                                <textarea class="form-control" name="e_short_desc" placeholder="Enter short desc"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label>Product Image <small>(format: jpg, jpeg, png)</small></label>
                                <input type="file" name="e_product_image" class="form-control"> <br>
