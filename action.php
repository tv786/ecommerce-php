				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-body'>
									<a href='item.php?id={$row['product_id']}'><img src='product_images/$pro_image' style='width:220px; height:250px;'/> </a>
								</div>
...
if(isset($_POST["get_seleted_Category"]) || isset($_POST["selectBrand"]) || isset($_POST["search"])){
	if(isset($_POST["get_seleted_Category"])){
		...
		$sql = "SELECT * FROM products WHERE product_keywords = '%$keyword%'";
	}
				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
                                ...
                                <a href='item.php?id={$row['product_id']}'>
									<img src='product_images/$pro_image' style='width:220px; height:250px;'/> </a>
								</div>
		...
		if($count > 0){
            ...
            echo "
					<div class='alert alert-danger'>
						<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
						<b>To Add Product in cart, Login First!</b>
					</div>
				";
        }
...
if (isset($_POST["count_item"])) {
	...
	if (isset($_SESSION["uid"])) {
		...
		//When user is not logged in then we will just show 0 items
		echo "0";
	}
			...
			while ($row=mysqli_fetch_array($query)) {
				...
				echo '
					<div class="row">
						...
						<div class="col-md-5">'.$product_title.'</div>
			...
			echo "<form method='post' action='login_form.php'>";
				...
				while ($row=mysqli_fetch_array($query)) {
					...
					$qty = $row["qty"];
                     ...
                     $user_id  = $_SESSION["uid"];
                     $result = "SELECT * FROM design_details WHERE u_id='$user_id' AND pro_id='$product_id'";
					 ...
					 echo 
						'<div class="row">
                                ...
                                <div class="col-md-2"><img src="'.$data['design_img'].'" 
                                width="110" height="140"></div>  
				...
				if(isset($_SESSION["uid"])){
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost:8080/ecommerce-app/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost:8080/ecommerce-app/payment_success.php"">
									<input type="hidden" name="cancel_return" value="http://localhost:8080/ecommerce-app/cart.php"/>
