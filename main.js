$(document).ready(function () {
    ...
    /*when user click on category we will get category id and according to id we will show products
     */
    ...
    /* when user click on brand we will get brand id and according to brand id we will show products 
     */
    ...
    /* we will match user search to our database keywords column then matched product we will show 
     */
    ...
    /* if user is logged in successfully and window.location is used to redirect user from home page to profile.php page
     */
